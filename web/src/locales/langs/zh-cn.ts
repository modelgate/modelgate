const local: App.I18n.Schema = {
  ...
  route: {
    ...
    relay_provider: '模型厂商',
    relay_model: '模型列表',
    "relay_model-pricing": '模型价格',
    "relay_provider-api-key": 'API Key',
    "relay_account": '账户管理',
    "user": '用户管理',
    "user_account": '账号管理',
    "user_api-key": 'API Key',
    "usage": '用量管理',
    "usage_request": '请求管理',
    "usage_ledger": '账单管理',
  },
  page: {
    ...
    relay: {
      ...
      providerApiKey: {
        title: 'APIKey列表',
        addProviderApiKey: '新增APIKey',
        editProviderApiKey: '编辑APIKey',
        providerId: '厂商',
        providerCode: '厂商代码',
        name: '名称',
        key: '密钥',
      ...
      modelPricing: {
        title: '模型定价列表',
        addModelPricing: '新增模型定价',
        editModelPricing: '编辑模型定价',
        providerCode: '厂商代码',
        modelCode: '模型代码',
        currency: '货币',
        pointsPerCurrency: '点数/货币',
        tokenNum: 'Token数量',
        inputPrice: '输入价格',
        inputCachePrice: '输入缓存价格',
        outputPrice: '输出价格',
        effectiveFrom: '生效时间',
        effectiveTo: '失效时间',
        status: '状态',
    ...
    user: {
      ...
      apiKey: {
        ...
        keyModal: {
          title: 'API Key 生成成功',
          warningTitle: '重要提示',
          warningMessage: '此 API Key 只会显示一次，请立即复制并妥善保管！',
          yourKey: '您的 API Key：',
          copied: '已复制',
          copy: '复制',
          confirm: '我已复制，关闭'
