...
import type { GetUserListRequest } from '@/typings/proto/admin/v1/system';
...
const model = defineModel<GetUserListRequest>('model', { required: true });

type RuleKey = Extract<keyof GetUserListRequest, 'email' | 'phone'>;
