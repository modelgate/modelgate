...
func Init(i do.Injector) {
	...
	// 阿里云百炼同时支持 OpenAI 和 Anthropic 协议，根据 opts.UrlPath 选择对应 handler
	core.ExecutorRegistry.Register(core.ProviderCodeAli, func(opts core.Options) (core.Executor, error) {
